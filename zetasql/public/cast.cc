...
#define ADD_TO_MAP(from_type, to_type, cast_type) \
  ...
  ADD_TO_MAP(INT32,      VARIANT,    EXPLICIT);
  ADD_TO_MAP(INT32,      TIMESTAMP,  EXPLICIT);
  ...
  ADD_TO_MAP(INT64,      VARIANT,    EXPLICIT);
  ADD_TO_MAP(INT64,      TIMESTAMP,  EXPLICIT);
  ...
  ADD_TO_MAP(UINT32,     VARIANT,    EXPLICIT);
  ...
  ADD_TO_MAP(UINT64,     VARIANT,    EXPLICIT);
  ...
  ADD_TO_MAP(BIGNUMERIC, VARIANT,    EXPLICIT);
  ...
  ADD_TO_MAP(DOUBLE,     VARIANT,    EXPLICIT);

  ADD_TO_MAP(STRING,     INT32,      IMPLICIT);
  ADD_TO_MAP(STRING,     INT64,      IMPLICIT);
  ADD_TO_MAP(STRING,     UINT32,     EXPLICIT);
  ADD_TO_MAP(STRING,     UINT64,     EXPLICIT);
  ADD_TO_MAP(STRING,     FLOAT,      EXPLICIT);
  ADD_TO_MAP(STRING,     DOUBLE,     IMPLICIT);
  ADD_TO_MAP(STRING,     STRING,     IMPLICIT);
  ADD_TO_MAP(STRING,     BYTES,      EXPLICIT);
  ADD_TO_MAP(STRING,     DATE,       IMPLICIT);
  ADD_TO_MAP(STRING,     TIMESTAMP,  IMPLICIT);
  ...
  ADD_TO_MAP(DATETIME,   VARIANT,    EXPLICIT);

  ADD_TO_MAP(INTERVAL,   INTERVAL,   IMPLICIT);
  ADD_TO_MAP(INTERVAL,   STRING,     EXPLICIT);
  ADD_TO_MAP(INTERVAL,   VARIANT,    EXPLICIT);

  ADD_TO_MAP(GEOGRAPHY,  GEOGRAPHY,  IMPLICIT);
  ADD_TO_MAP(GEOGRAPHY,  VARIANT,    EXPLICIT);

  ADD_TO_MAP(JSON,       JSON,       IMPLICIT);
  ADD_TO_MAP(JSON,       VARIANT,    IMPLICIT);
  ...
  ADD_TO_MAP(PROTO,      VARIANT,    IMPLICIT);

  ADD_TO_MAP(RANGE,      STRING,     EXPLICIT);
  ADD_TO_MAP(RANGE,      VARIANT,    IMPLICIT);
  ...
  ADD_TO_MAP(ARRAY,      VARIANT,    IMPLICIT);
  ADD_TO_MAP(STRUCT,     STRUCT,     IMPLICIT);
  ADD_TO_MAP(RANGE,      RANGE,      IMPLICIT);

  ADD_TO_MAP(VARIANT,    INT32,      EXPLICIT);
  ADD_TO_MAP(VARIANT,    INT64,      EXPLICIT);
  ADD_TO_MAP(VARIANT,    UINT32,     EXPLICIT);
  ADD_TO_MAP(VARIANT,    UINT64,     EXPLICIT);
  ADD_TO_MAP(VARIANT,    FLOAT,      EXPLICIT);
  ADD_TO_MAP(VARIANT,    DOUBLE,     EXPLICIT);
  ADD_TO_MAP(VARIANT,    STRING,     IMPLICIT);
  ADD_TO_MAP(VARIANT,    BYTES,      EXPLICIT);
  ADD_TO_MAP(VARIANT,    DATE,       EXPLICIT);
  ADD_TO_MAP(VARIANT,    TIMESTAMP,  EXPLICIT);
  ADD_TO_MAP(VARIANT,    TIME,       EXPLICIT);
  ADD_TO_MAP(VARIANT,    DATETIME,   EXPLICIT);
  ADD_TO_MAP(VARIANT,    INTERVAL,   EXPLICIT);
  ADD_TO_MAP(VARIANT,    ENUM,       EXPLICIT);
  ADD_TO_MAP(VARIANT,    PROTO,      EXPLICIT);
  ADD_TO_MAP(VARIANT,    BOOL,       EXPLICIT);
  ...
  ADD_TO_MAP(VARIANT,    ARRAY,      IMPLICIT);

  ADD_TO_MAP(OBJECT,     VARIANT,    IMPLICIT);
